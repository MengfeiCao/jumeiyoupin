...
var rePassword = document.querySelector(".rePassword"); // ----------------------正则验证------------------
// 1.非法输入提示
// 2.未经验证严禁提交
// 验证账号
...
function confirmUsername() {
  var user_reg = /^\d{11}$/;
  var tip = username.parentNode.children[1];
  var user_value = username.value; // console.log(user_value);
...
function confirmYanzhengma() {
  ...
  var tip = username.parentNode.children[3];
  var yanzhengma_value = yanzhengma.value; // console.log(user_value);
...
function confirmPassword() {
  var pas_reg = /^\w{6,16}$/;
  var tip = username.parentNode.children[5];
  var pass_value = password.value; // console.log(user_value);
...
function confirmRePassword() {
  ...
  var repass_value = rePassword.value; // console.log(user_value);
...
function submitForm(evt) {
  ...
  url += "?username=".concat(user_value, "&password=").concat(pass_value);
